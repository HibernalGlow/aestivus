...
import { Image, Folder, Play, List, Copy } from '@lucide/svelte';
...
export const KAVVKA_DEFAULT_GRID_LAYOUT: GridItem[] = [
  { id: 'source', x: 0, y: 0, w: 3, h: 2, minW: 2, minH: 1 },
  { id: 'operation', x: 3, y: 0, w: 1, h: 2, minW: 1, minH: 2 },
  { id: 'result', x: 0, y: 2, w: 3, h: 3, minW: 2, minH: 2 },
