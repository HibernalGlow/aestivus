...
import { FolderOpen, FilePenLine, Play, FolderTree, RefreshCw, Upload, Settings2, Copy, History } from '@lucide/svelte';
...
export const TRENAME_DEFAULT_GRID_LAYOUT: GridItem[] = [
  ...
  { id: 'log', x: 2, y: 5, w: 1, h: 2, minW: 1, minH: 1 },
  { id: 'history', x: 3, y: 5, w: 1, h: 2, minW: 1, minH: 1 }
];
